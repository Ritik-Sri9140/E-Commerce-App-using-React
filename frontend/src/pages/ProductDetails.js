        ...
        {/* Product Deatils */}
        {
          loading ? (
            <div className='grid w-full gap-1'>
              ...
              <div className='text-red-600 flex items-center gap-1 bg-slate-200 animate-pulse h-6 lg:h-8 w-full'>
                
              </div>

              <div className='flex items-center gap-2 text-2xl font-medium my-1 lg:text-3xl animate-pulse h-6 lg:h-8 w-full'>
              ...
              <div className='w-full'>
                ...
                <p className='bg-slate-200 animate-pulse h-10 lg:h-8 rounded w-full'></p>
              </div>
